...
namespace Benday.Presidents.Core.Factories
{
    public class ObjectFactory : IObjectFactory
    {
        ...
        private void RegisterTypes()
        {
            ...
            RegisterType<IFeatureManager, FeatureManager>();
            ...
            RegisterType<IFeatureRepository, SqlEntityFrameworkFeatureRepository>();

            // RegisterType<IPresidentService, PresidentService>();

            var featureConfig = Create<IFeatureManager>();

            if (featureConfig.FeatureUsageLogging == false)
            {
                RegisterType<IPresidentService, PresidentService>();
            }
            else
            {
                RegisterType<IPresidentService, PresidentServiceWithLogging>();
            }
        }
    }
}
